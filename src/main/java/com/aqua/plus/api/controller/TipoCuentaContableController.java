...
import com.aqua.plus.api.service.impl.TipoCuentaContableServiceImpl;
...
@RestController
@RequestMapping("/api/v1/tipo-cuenta-contable")
@Tag(name = "TipoCuentaContable - Controller", description = "Controller encargado de gestionar las operaciones de los tipos de cuentas contables")
@CrossOrigin(origins = "*", methods = { RequestMethod.DELETE, RequestMethod.GET, RequestMethod.POST,
		RequestMethod.PUT })
@RequiredArgsConstructor
public class TipoCuentaContableController {

	private final TipoCuentaContableServiceImpl tipoCuentaServiceImpl;
    ...
    @PostMapping
    public ResponseEntity<ResponseDTO> save(@RequestBody TipoCuentaContableDTO tipoCuentaDTO) {
        return tipoCuentaServiceImpl.save(tipoCuentaDTO);
    }
    ...
    public ResponseEntity<ResponseDTO> getById(@PathVariable Integer id) {
        return tipoCuentaServiceImpl.findById(id);
    }
    ...
    public ResponseEntity<ResponseDTO> getAll() {
        return tipoCuentaServiceImpl.findAll();
    }
    ...
    public ResponseEntity<ResponseDTO> deleteById(@PathVariable Integer id) {
        return tipoCuentaServiceImpl.deleteById(id);
    }
}
