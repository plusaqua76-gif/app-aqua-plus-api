...
import com.aqua.plus.api.service.impl.EstadoServiceImpl;
...
@Tag(name = "Estado - Controller", description = "Controller encargado de gestionar las operaciones de los estados")
...
public class EstadoController {
    ...
    @PostMapping
    public ResponseEntity<ResponseDTO> save(@RequestBody EstadoDTO estadoDTO) {
        return estadoServiceImpl.save(estadoDTO);
    }
    ...
    public ResponseEntity<ResponseDTO> deleteById(@PathVariable Integer id) {
        return estadoServiceImpl.deleteById(id);
    }
}
