...
import com.aqua.plus.api.service.impl.MenuServiceImpl;
...
@Tag(name = "Menu - Controller", description = "Controller encargado de gestionar las operaciones de los menus")
...
public class MenuController {
	...
	@Operation(summary = "Guardar o actualizar menu")
	@ApiResponses(value = {
    ...
    @PostMapping
    public ResponseEntity<ResponseDTO> save(@RequestBody MenuDTO menuDTO) {
        return menuServiceImpl.save(menuDTO);
    }
	...
	@Operation(summary = "Eliminar menu por id")
    @ApiResponses(value = {
    ...
    public ResponseEntity<ResponseDTO> deleteById(@PathVariable Integer id) {
        return menuServiceImpl.deleteById(id);
    }
}
