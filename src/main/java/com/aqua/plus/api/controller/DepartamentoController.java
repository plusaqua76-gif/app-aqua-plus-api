...
import com.aqua.plus.api.service.impl.DepartamentoServiceImpl;
...
@Tag(name = "Departamento - Controller", description = "Controller encargado de gestionar las operaciones de los departamentos")
...
public class DepartamentoController {
	...
	@Operation(summary = "Guardar o actualizar departamento")
	@ApiResponses(value = {
    ...
    @PostMapping
    public ResponseEntity<ResponseDTO> save(@RequestBody DepartamentoDTO departamentoDTO) {
        return departamentoServiceImpl.save(departamentoDTO);
    }
    ...
    public ResponseEntity<ResponseDTO> deleteById(@PathVariable Integer id) {
        return departamentoServiceImpl.deleteById(id);
    }
}
