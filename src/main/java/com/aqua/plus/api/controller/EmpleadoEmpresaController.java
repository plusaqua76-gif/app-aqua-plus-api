...
import com.aqua.plus.api.service.impl.EmpleadoEmpresaServiceImpl;
...
@RestController
@RequestMapping("/api/v1/empleado-empresa")
...
public class EmpleadoEmpresaController {
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "500", description = "Error interno del servidor", content = {
					@Content(mediaType = "application/json", schema = @Schema(implementation = ResponseDTO.class)) }), })
	@PostMapping("/estado")
	public ResponseEntity<Map<String, Object>> actualizarEstadoEmpleado(@RequestBody Map<String, Object> jsonParams) {
		try {
	...
	@PutMapping("/update")
	public ResponseEntity<Map<String, Object>> actualizarEmpleado(@RequestBody Map<String, Object> jsonParams) {
		try {
