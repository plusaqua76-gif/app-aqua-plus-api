...
@RestController
@RequestMapping("/api/v1/cliente-novedad")
@Tag(name = "ClienteNovedad - Controller", description = "Controller encargado de gestionar las operaciones de Cliente Novedad")
@CrossOrigin(origins = "*", methods = { RequestMethod.DELETE, RequestMethod.GET, RequestMethod.POST,
		RequestMethod.PUT })
@RequiredArgsConstructor
public class ClienteNovedadController {

	private final ClienteNovedadServiceImpl clienteNovedadServiceImpl;

	@Operation(summary = "Crear novedad (PQR) del cliente")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Novedad creada correctamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ResponseDTO.class))),
	...
	@PostMapping
	public ResponseEntity<ResponseDTO> crear(@RequestBody ClienteNovedadRequestDTO request) {
		return clienteNovedadServiceImpl.save(request);
	}

	@Operation(summary = "Buscar Cliente Novedad por id")
	@ApiResponses(value = {
	...
	public ResponseEntity<ResponseDTO> getAll() {
		return clienteNovedadServiceImpl.findAll();
	}

	@Operation(summary = "Eliminar Cliente Novedad por id")
	@ApiResponses(value = {
	...
	public ResponseEntity<ResponseDTO> deleteById(@PathVariable Integer id) {
		return clienteNovedadServiceImpl.deleteById(id);
	}

	@Operation(summary = "actualizar Cliente Novedad")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "201", description = "Se ha guardado satisfactoriamente", content = {
					@Content(mediaType = "application/json", schema = @Schema(implementation = ResponseDTO.class)) }),
