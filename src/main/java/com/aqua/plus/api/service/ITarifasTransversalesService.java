 ...
 * 
 */
public interface ITarifasTransversalesService {

	ResponseEntity<ResponseDTO> save(TarifasTransversalesDTO dtos);

	ResponseEntity<ResponseDTO> findByEnterpriseId(Integer empresaId);
